...
class Page(db.Model):
    ...
    favicon = db.Column(db.String(255), nullable=True) # <------------- needs to be added
    font = db.Column(db.String(255), nullable=True) # <------------- needs to be added
    linkColor = db.Column(db.String(255), nullable=True) # <------------- needs to be added
    isOpen = db.Column(db.Boolean(), nullable=True) # <------------- needs to be added
    ...
    def to_dict(self):
        return {
          ...
          "link4Text": self.link3Text,
          "link4Url": self.link3Url,
          "link5Text": self.link3Text,
          "link5Url": self.link3Url,
